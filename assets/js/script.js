  ...
  var doneH2El = document.getElementById("done-h2");
...
var startQuiz = function() {
  ...
  startTextEl.textContent = "Try to answer the following code-related questions within the time limit. Keep in mind that inncorrect answers will penalize your score/time by ten seconds!";
...
startButtonEl.addEventListener("click", function(){
  ...
  var question_2 = function() {
    ...
    questionEl.textContent = "The condition in an if/else if statement is enclosed with_____.";
    button1El.setAttribute("style", "color: white; padding: 10px 60px;");
  ...
  var question_4 = function() {
    ...
    questionEl.textContent = "String values must be enclosed within_____when being assigined to variables.";
    button1El.setAttribute("style", "color: white; padding: 10px 60px;");
    button2El.setAttribute("style", "color: white; padding: 10px 40px;");
    button3El.setAttribute("style", "color: white; padding: 10px 60px;");
  ...
  var question_5 = function() {
    ...
    questionEl.textContent = "A very useful tool used during development and debugging for printing content to debugger is:";
